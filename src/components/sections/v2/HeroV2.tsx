...
export default function HeroV2() {
  ...
  return (
    <section className="relative bg-ss-hero min-h-screen flex items-center">
      {/* Organic background movement overlay */}
      {!prefersReduced && (
        <div
          className="pointer-events-none absolute inset-0 hero-animated-bg"
          style={{ opacity: 0.20, mixBlendMode: 'screen' }}
        />
      )}
      {/* Radial vignette */}
      <div
      ...
      <div
        className="mx-auto w-full max-w-[1200px] px-6 relative py-32"
        ...
        <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-2">
          ...
          <motion.div variants={containerVariants} initial="hidden" animate="visible">
            ...
            <motion.h1
              ...
              style={{ fontSize: 'clamp(38px, 5vw, 68px)', lineHeight: 1.05, textWrap: 'pretty' }}
            >
            ...
            <motion.p
              variants={itemVariants}
              className="font-sans text-[18px] leading-[1.6] mb-4 max-w-xl"
              style={{ color: 'rgba(255,255,255,0.80)' }}
            >
              End-to-end marketing automation that creates content, distributes across channels,
              tracks every lead, and optimizes for conversions — so you can focus on closing deals,
              not managing campaigns.
            </motion.p>

            <motion.p
              variants={itemVariants}
              className="font-sans text-[14px] leading-[1.6] mb-10 max-w-lg"
              style={{ color: 'rgba(255,255,255,0.55)' }}
            >
              Professional marketing execution without the agency cost or tool chaos.
              SuperSymm automates your entire marketing operation from content creation
              to lead scoring. From $2,500/month with custom setup.
            </motion.p>
