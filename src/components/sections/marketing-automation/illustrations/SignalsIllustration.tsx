...
export default function SignalsIllustration() {
  ...
  return (
    <svg
      ...
      role="img"
      aria-label="Line graph showing lead score rising over time with three trigger points — Email sent, Sequence adjusted, and Sales alerted"
    ...
    >
      ...
      {TRIGGERS.map((trigger, i) => {
        ...
        return (
          ...
          >
            ...
            {/* Static label below for accessibility */}
            {!isHovered && (
              <text
                x={trigger.x}
                y={352}
      ...
      <g>
        <circle cx="425" cy="80" r="14" fill="var(--ss-yellow)" opacity="0.9" />
        {/* Star shape */}
        <text
          x="425"
          y="85"
